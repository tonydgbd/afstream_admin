    ...
    <div class="colxl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-title-wrapper">
            <div class="page-title-box">
                <h4 class="page-title bold">{{ __('adminWords.all').' '.__('adminWords.language') }}</h4>
            </div>
            <div class="musioo-brdcrmb breadcrumb-list">
                <ul>
                    ...
                    <li class="breadcrumb-link active">{{ __('adminWords.all').' '.__('adminWords.language') }}</li>
                </ul>
            </div>
        </div>
    </div> 
			...
			<div class="card m-b-30">
				<div class="card-header">                                
					<div class="row align-items-center">
						...
						<div class="col-6">
                            <div class="btn-right">
                                <a class="effect-btn btn btn-primary mr-2 languagePopupToggle" data-add="1" data-url="{{route('addEditLanguage','create')}}"><i class="feather icon-plus mr-2"></i>{{ __('adminWords.create').' '.__('adminWords.language') }}</a>
								<button type="button" class="effect-btn btn btn-danger" id="bulkDelete" data-msg="{{ __('adminWords.atleast').' '.__('adminWords.audio_genre').' '.__('adminWords.must_selected') }}" data-url="{{route('language.bulk_delete')}}"><i class="far fa-trash-alt mr-2 "></i> {{ __('adminWords.delete_selected') }}</button>  
                            </div>
                        </div>
					</div>
				</div>
				<div class="card-body">
					<div class="table-responsive">
						<form method="post" id="languageForm">
							<table data-method="post" id="datatable-buttons" class="table table-styled musiooDtToShowData" data-url="{{route('languageData')}}">
								<thead>
									<tr> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="row">
                            ...
                            <div class="checkbox custom-switch">
                                <input id="switchDefault" name="is_default" type="checkbox">
                                <label for="switchDefault"></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12">
