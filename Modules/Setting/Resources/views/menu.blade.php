            ...
            <div class="card m-b-30">
                <div class="card-header">                                
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="card-title mb-0">{{ __('adminWords.menu') }}</h5>
                        </div>
                        <div class="col-6">
                            <div class="btn-right">
                                <a href="{{url('/create_menu')}}" class="effect-btn btn btn-primary mt-2 mr-2"><i class="feather icon-plus mr-2"></i>{{ __('adminWords.create').' '.__('adminWords.menu') }}</a>
                                <button type="button" class="effect-btn btn btn-danger mt-2 mr-2" id="bulkDelete" data-msg="{{ __('adminWords.atleast').' '.__('adminWords.menu').' '.__('adminWords.must_selected') }}" data-url="{{url('/bulkDeleteMenu')}}"><i class="far fa-trash-alt mr-2 "></i> {{__('adminWords.delete_selected')}}</button>  
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form method="post" id="menuForm">
                        <table id="datatable-buttons" class="table table-styled musiooDtToShowData" data-url="{{route('show_menu')}}" data-method="post">
                            <thead>
                                <tr>
                                  ...
                                  <th>{{ __('adminWords.menu_heading') }}</th>
                                  <th>{{ __('adminWords.page_name') }}</th>
