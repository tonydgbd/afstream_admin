            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-2 mt-3 mb-2">
                        <h4 class="font-size-15"> {{ __('adminWords.order_summary') }} </h4>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        @if(isset($settings['set_tax']) && $settings['set_tax'] == 1)
                                            @php    
                                                ...
                                                $taxAmount = ($settings['tax'])*$invoiceData->amount/100;
                                            @endphp
                                        @endif
                                        
                                        <td>{{ number_format($invoiceData->amount-$taxAmount,2) }}</td>
                                        
                                        <td>{{ $taxPercent }}</td>
                                        
                                        <td>{{ $paymentData->currency.$taxAmount }}</td>
                                        
                                        <td>{{ $paymentData->currency.number_format($invoiceData->amount,2) }}</td>
