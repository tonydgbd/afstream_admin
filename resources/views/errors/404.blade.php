                    ...
                    <div class="error-content-wrap">
                        <div class="error-logo-wrap">
                            @if(isset($settings['large_logo']))
                                <img src="{{ asset('public/images/sites/'.$settings['large_logo']) }}" class="img-fluid error-logo" alt="logo">
                            @endif
                        </div>
                        <div class="error-img-wrap">
                            <img src="{{ asset('public/assets/images/error/404.svg') }}" class="img-fluid error-image" alt="404">
                        </div>
