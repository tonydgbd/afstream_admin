    ...
    <div class="musiooFrontSinglePage">
        ...
        <div class="ms_artist_wrapper common_pages_space">
                                    ...
                                    <div class="col-lg-2 col-md-6">
                                        <div class="ms_rcnt_box marger_bottom30">
                                                    ...
                                                    <ul>
                                                        <li class="list_more">
                                                            ...
                                                            <ul class="ms_common_dropdown ms_downlod_list list_more">    
                                                                ...
                                                                <!-- 
                                                                <li>
                                                                    <a href="javascript:void(0);" class="yt_add_to_queue" data-musicid="{{ $videoId }}" data-musictype="playlist">
                                            ...
                                            <div class="ms_rcnt_box_text">
                                                <h3>
                                                    <a href="javascript:void(0)" class="yt_music" data-musicid="{{ $videoId }}" data-title="{{ $music->snippet->title }}" data-musictype="ytBrowseSearch" data-image="{{ $ytImage }}">
                                                        {{ $music->snippet->title }}
                                                    </a>
                                                </h3>
                                                <p></p>
            ...
            @php if(sizeof($albums) <= 0 && sizeof($audios) <= 0 && sizeof($artistData) <= 0 && sizeof($ytBrowseSearch) <= 0) { @endphp
                <div class="col-lg-12"><div class="ms_empty_data"><p>No such record found</p></div></div>
            @php } @endphp
        </div>    
