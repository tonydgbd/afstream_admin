...
@inject('ytModel', 'Alaouy\Youtube\Facades\Youtube')
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="music_center_mainbox text-center">
                                                            ...
                                                            <div class="music_center_info">
                                                                <a href="{{ url('album/single/'.$album->id.'/'.$album->album_slug) }}" class="music_center_title limited_text_line">{{ $album->album_name }}</a>
                                                                <p class="music_center_sub limited_text_line"> {{ rtrim(($artist_name != '' ? $artist_name : '') , ',') }}</p>
                                                                <div class="music_center_details">
                                                                    <a class="ms_btn" href="{{ url('album/single/'.$album->id.'/'.$album->album_slug) }}"> Play All</a>
                                                ...
                                                <div class="swiper-wrapper">
                                                    <?php
                                                        foreach($playlist['playlist_audio'] as $audio){
                                                            ...
                                                            echo'<div class="swiper-slide play_btn play_music play_icon_btn" data-musicid="'.$audio->id.'" data-musictype="audio" data-url="'.url('/songs').'">
                                                                    <div class="slider_cbox slider_artist_box text-center play_box_container">
                                ...
                                <div class="swiper-wrapper">
                                    @php 
                                        foreach($trending_audio as $audio){
                                            ...
                                            echo'<div class="swiper-slide play_btn play_music" data-musicid="'.$audio->id.'" data-musictype="audio" data-url="'.url('/songs').'">
                                                    <div class="slider_cbox slider_artist_box text-center play_box_container">
                                                        <div class="slider_cimgbox slider_artist_imgbox play_box_img">'.$img.'</div>
                                                        <div class="ms_play_icon">
                                                            <img src="'. asset('public/images/svg/play.svg').'" alt="play icone">
