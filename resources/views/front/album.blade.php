                    ...
                    @endphp
                        <div class="ms_artist_innerslider">
                            <div class="row custom-grid">
                                    ...
                                    @endphp
                                    <div class="col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6  mb-4 play_btn play_music play_icon_btn" data-musicid="{{ $album->id }}" data-musictype="album" data-url="{{ url('/songs') }}">
                                        <div class="slider_cbox slider_artist_box text-center play_box_container mb-20">
                                            ...
                                            <div class="slider_ctext slider_artist_text">
                                                <a href="javascript:void(0);" class="slider_ctitle slider_artist_ttl limited_text_line getAjaxRecord" data-type="album" data-url="{{ url('album/single/'.$album->id.'/'.$album->album_slug) }}">{{ $album->album_name }}</a>
                                            </div>
                                        </div>
                                    </div>   
                                    @php   }
