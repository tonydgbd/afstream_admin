                                                ...
                                                <div class="col-xl-2 col-md-3 col-6">
                                                    <div class="slider_cbox slider_artist_box text-center play_box_container">
                                                        ...
                                                        <div class="slider_ctext slider_artist_text">
                                                            <a class="slider_ctitle slider_artist_ttl limited_text_line getAjaxRecord" data-type="audio" data-url="{{ url('audio/single/'.$audio->id.'/'.$audio->audio_slug) }}">{{ $audio->audio_title }}</a>
