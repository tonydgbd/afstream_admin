            ...
            <div class="album_single_data">
                ...
                @endphp
                    ...
                    <div class="album_single_text">
                        ...
                        <div class="album_btn">
                            <a href="javascript:void(0)" class="ms_btn play_btn play_music" data-musicid="{{ $genres->id }}" data-musictype="genre" data-url="{{ url('/songs') }}"><span class="play_all"><img src="{{ asset('public/assets/images/svg/play_all.svg') }}" alt="">{{ __('frontWords.play_all') }}</span><span class="pause_all"><img src="{{ asset('public/assets/images/svg/pause_all.svg') }}" alt="">{{ __('frontWords.pause') }}</span></a>
                            <a href="javascript:void(0);" class="ms_btn add_to_queue" data-musicid="{{ $genres->id }}" data-musictype="genre"><span class="play_all"><img src="{{ asset('public/assets/images/svg/add_q.svg') }}" alt="">{{ __('frontWords.add_to_queue') }}</span></a>
                        </div>
                    </div>
