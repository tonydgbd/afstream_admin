                                            ...
                                            if(sizeof($getArtist) > 0){
                                                ...
                                                <ul class="removeFavRow">  <!-- play_active_song -->
                                                    ...
                                                    <li class="text-center">
                                                        <a href="javascript:void(0);" class="addToFavourite" data-favourite="{{ $audios->id }}" data-type="audio" data-page="favourite_page">
                            ...
                            @endphp
                                            <div class="swiper-slide play_btn play_music play_icon_btn" data-musicid="{{ $artist->id }}" data-musictype="artist" data-url="{{ url('/songs') }}">
                                                <div class="slider_cbox slider_artist_box text-center play_box_container">
                                                    ...
                                                    <div class="slider_ctext slider_artist_text">
                                                        <a class="slider_ctitle slider_artist_ttl limited_text_line getAjaxRecord" data-type="artist" data-url="{{ url('artist/single/'.$artist->id.'/'.$artist->artist_slug) }}" href="javascript:void(0)">{{ $artist->artist_name }}</a>                                          
                ...
                <div class="col-lg-2 col-md-6">
                        <div class="ms_rcnt_box marger_bottom25">
                            ...
                            <div class="ms_rcnt_box_text">
                                <h3><a class="limited_text_line getAjaxRecord" data-type="playlist" data-url="{{ url('playlist/single/'.$list->id)}}" href="javascript:void(0)">{{ $list->playlist_name }}</a></h3>
