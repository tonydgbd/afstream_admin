        ...
        <div class="container-fluid">
                ...
                <div class="ms_artist_slider play-list-slider">
                    ...
                    <div class="swiper-container">
        				<div class="swiper-wrapper" id="setCreatedPlaylist">
                    ...
                    <div class="swiper-slide">
                        <div class="ms_rcnt_box marger_bottom25 playlist_boxes">
                            ...
                            <div class="ms_rcnt_box_text">
                                <h3><a class="getAjaxRecord" data-type="playlist" data-url="{{ url('playlist/single/'.$list->id)}}" href="javascript:void(0)" >{{ $list->playlist_name }}</a></h3>
                ...
                <div class="row">
                    <div class="col-xxl-2 col-xl-4 col-lg-6 col-md-6">
                        <div class="ms_rcnt_box marger_bottom25">
                            ...
                            <div class="ms_rcnt_box_text">
                                <h3><a href="javascript:void(0);">{{ __('frontWords.create_playlist') }}</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
