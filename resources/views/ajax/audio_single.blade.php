        ...
        <div class="ms_artist_single padder_top80">
            <div class="album_single_data">
                ...
                <div class="album_single_text">
                    ...
                    <div class="album_btn">
                        <a href="javascript:void(0)" class="ms_btn play_btn play_music" data-musicid="{{ $audio[0]->id }}" data-musictype="audio" data-url="{{ url('/songs') }}"><span class="play_all"><img src="{{ asset('assets/images/svg/play_all.svg') }}" alt="" >{{ __('frontWords.play') }}</span><span class="pause_all"><img src="{{ asset('assets/images/svg/pause_all.svg') }}" alt="">{{ __('frontWords.pause') }}</span></a>
                            ...
                            <ul class="ms_common_dropdown ms_downlod_list list_more">      
                                ...
                                <li>
                                    ...
                                    @elseif(!empty($userPlan) && $userPlan->is_download == 1)                                        
                                        ...
                                        @else    
                                            <a href="javascript:void(0);" class="download_track" data-musicid="{{ $audio[0]->id }}">
                                                <span class="common_drop_icon drop_downld"></span>{{ __("frontWords.download_now") }} 
                                            </a>
                                        @endif
                                ...
                                @endphp
                                            <div class="swiper-slide play_btn play_icon_btn">
                                                <div class="slider_cbox slider_artist_box text-center play_box_container">
                                                    <div class="slider_cimgbox slider_artist_imgbox play_box_img play_music" data-musicid="{{ $similarAudio->id }}" data-musictype="audio" data-url="{{ url('/songs') }}">
                                                    ...
                                                    <div class="slider_ctext slider_artist_text">
                                                        <a class="slider_ctitle slider_artist_ttl getAjaxRecord" data-type="audio" data-url="{{ url('audio/single/'.$similarAudio->id.'/'.$similarAudio->audio_slug) }}" href="javascript:void(0)">{{ $similarAudio->audio_title }}</a>                                          
                ...
                <div class="ms_cmnt_wrapper">
                    ...
                    <div class="ms_cmnt_form">
                        <form method="post" id="ratingForm" action="{{ url('audio/rating') }}">
                            ...
                            <div class="form-group">
                                <div class="ms_input">
                                    <a href="javascript:void(0);" class="ms_btn" data-action="submitThisForm">{{ __('frontWords.submit') }}</a>
                                </div>
                            </div>
                        </form>
                    </div>
