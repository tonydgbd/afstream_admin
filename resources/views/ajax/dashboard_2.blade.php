                    ...
                    @endif 
                        ...
                        <div class="ms_popular_artist_wrapper ms_artist_slider recommended_artist_slider mb-0">
                            <div class="slider_heading_wrap">
                                ...
                                <div class="slider_cmn_controls">
                                    <a href="javascript:void(0);" class="ms_btn_link getAjaxRecord" data-type="artist" data-url="{{ route('user.artist') }}" title="{{ __('frontWords.top_artist') }}">{{ __("frontWords.view_more") }}</a> 
                                </div> 
                            </div>
                            <div class="row">
