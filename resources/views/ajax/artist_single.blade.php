                    ...
                    <li class="list_more">
                        ...
                        <ul class="ms_common_dropdown ms_downlod_list list_more">     
                            ...
                            <li class="favourite_icon">
                                <a href="javascript:void(0);" class="addToFavourite" data-favourite="{{ $artist[0]->id }}" data-type="artist">
                                    @if($favourite == 1)
                            ...
                            <li>
                                <a href="javascript:void(0);" class="add_to_queue" data-musicid="{{ $artist[0]->id }}" data-musictype="artist">
                                <span class="opt_icon" title="Add To Queue"><span class="icon icon_queue"></span></span>
                                    {{ __("frontWords.add_to_queue") }}
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" class="ms_share_music" data-shareuri="{{ url('artist/single/'.$artist[0]->id.'/'.$artist[0]->artist_slug) }}" data-sharename="{{ $artist[0]->artist_name }}">
