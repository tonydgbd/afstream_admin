/*! jPlayerPlaylist for jPlayer 2.9.2 ~ (c) 2009-2014 Happyworm Ltd ~ MIT License */ ! function(a, b) {
    jPlayerPlaylist = function(b, c, d) {
        ...
        _createListItem: function (t) {
                var i = this,
                    l = "<li><div class='col-md-12'>";
                if (
                    ((l +=
                        "<a href='javascript:void(0);' class='" +
                        this.options.playlistOptions.itemClass +
                        " col-md-10' tabindex='0'><span class='que_img'><img src='" +
                        t.image +
                        "' width='50px' height='50px'></span ><div class='que_data'>" +
                        t.title +
                        (t.artist ? " <span class='jp-artist'>by " + t.artist + "</span>" : "") +
                        "</div></a>"),
                    (l += "<a href='javascript:void(0);' class='" + this.options.playlistOptions.removeItemClass + " col-md-2' tabindex='0'><span class='que_close'><img src='" + userBaseUrl + "/public/assets/images/svg/close.svg'></span></a>"),
                    t.free)
                ) {
                    var o = !0;
        ...
        shuffle: function(c, d) {
            ...
            (c || c !== this.shuffled) && a(this.cssSelector.playlist + " ul").slideUp(this.options.playlistOptions.shuffleTime, function() {
                ...
                }) : e._originalPlaylist(), e._refresh(!e.current),
				d || !a(e.cssSelector.jPlayer).data("jPlayer").status.paused ? '' : e.select(0), 
