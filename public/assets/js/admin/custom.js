...
$(document).ready(function() {
    ...
    $(window).on("load", function() {
        ...
        if (colorcode != "") {
            ...
            if (cssname != '') {
                var new_style = adminBaseUrl+'/public/assets/css/admin/css_picker/' + cssname + '.css'; //asset('public/assets/css'  + cssname + '.css'); //'assets/css/' + cssname + '.css'; 
    ...
    $('.colorchange').on("click", function() {
        ...
        $.ajax({
            ...
            url: adminBaseUrl + '/dash_color',
            method: 'post',
            data: { 'dash_color' : name},
        ...
        var new_style = adminBaseUrl + '/public/assets/css/admin/css_picker/' + name + '.css'; //asset('public/assets/css'  + name + '.css'); //'assets/css/' + name + '.css';
        $('#theme-change').attr('href', new_style);
    });
    ...
    jQuery(".file-upload-wrapper").on("change", ".file-upload-field", function(){ 
